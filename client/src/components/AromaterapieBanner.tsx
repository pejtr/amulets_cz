  ...
  return (
    <section className="relative w-full overflow-hidden py-8">
      <div className="container mx-auto px-4">
        ...
        <div 
          className="relative w-full md:w-[80%] mx-auto h-[280px] md:h-[360px] lg:h-[400px] bg-cover bg-center bg-no-repeat rounded-2xl shadow-xl overflow-hidden"
        ...
        >
          ...
          <div className="absolute top-[55%] md:top-[52%] left-[8%] md:left-[10%]">
            <Button
              onClick={handleClick}
              size="lg"
              className="bg-gradient-to-r from-[#D4AF37] to-[#B8860B] hover:from-[#E5C158] hover:to-[#D4AF37] text-black font-bold px-6 md:px-10 py-4 md:py-6 text-base md:text-xl shadow-lg hover:shadow-xl transition-all duration-300 group rounded-full"
            >
